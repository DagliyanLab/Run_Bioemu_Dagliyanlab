BioEmu – Sidechain Rebuild Pipeline
...
✔ Works on any BioEmu sampling output directory

✔ Does not depend on manifest files

✔ Rebuilds directly into the original sampling directory

✔ Uses a task list generated by scanning directories

✔ Supports SLURM array jobs

✔ Clean, modular, stable
...
🚀 Step 1 — Generate Task List (Run in Terminal)
...
🏗 Step 2 — Submit SLURM Rebuild Job
Use:
```
cd /mimer/NOBACKUP/groups/naiss2025-5-451/Bioemu
